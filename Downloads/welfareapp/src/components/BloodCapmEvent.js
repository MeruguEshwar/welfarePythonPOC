...
const BloodCapmEvent = () => {
  ...
  return (
    ...
    <div className='row'>
      <div className='col-7' style={{ height: '37rem', backgroundColor: '#01BFBDE6' }}>
            ...
            <div className="card-body" style={{ backgroundColor: '#01BFBDE6' }}>
              <div className="col-lg-10">
                <div className="card-body p-md-2 text-black" >
                  <h4 className=" text-uppercase text-center ms-2" >BloodCapm Event Form</h4>
